...
public class RangeSlider: UIControl {
    @IBInspectable public var minimumValue: Double = 0.0001 {
        willSet(newValue) {
    ...
    var gapBetweenThumbs: Double {
        return 0.1 * Double(thumbWidth) * (maximumValue - minimumValue) / Double(bounds.width)
    }
    ...
    @IBInspectable public var thumbBorderColor: UIColor = .clear {
        didSet {
