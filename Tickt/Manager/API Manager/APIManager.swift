...
class ApiManager {
    ...
    class func request(methodName:String, parameters: [String:Any]?, authToken: String = "", methodType: HTTPMethod, showLoader: Bool = true, loadingText: String = "", result: @escaping (Result<Any>) -> ()) {
        ...
        headers["Authorization"] = kUserDefaults.getAccessToken().isEmpty ? ApiManager.authTokenString(ofUsername: "tickt_app", password: AppConstants.accessTokenPass) : kUserDefaults.getAccessToken()
